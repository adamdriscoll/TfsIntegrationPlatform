...
{
    [Serializable]
    public class WorkItemRevisionFileLinkType : LinkType, ILinkHandler
    {
        private const string REFERENCE_NAME = "Microsoft.TeamFoundation.Migration.TFS.LinkType.WorkItemToRevisionFile";
        private const string FRIENDLY_NAME = "Team Foundation Server WorkItem-to-Revision-File link type";
        ...
        public WorkItemRevisionFileLinkType()
