...
//
//*****************************************************************************
WinCredentials::Credential::Credential(Credential^ copy) :
    m_disposed(true)
{
    if (nullptr == copy)
    {
...
//
//*****************************************************************************
WinCredentials::Credential::Credential(String^ targetName,
                             CredentialType type) :
    m_disposed(true)
{
...
//
//*****************************************************************************
WinCredentials::Credential::~Credential()
{
    if (!m_disposed)
    {
        delete m_password;
...
//
//*****************************************************************************
String^ WinCredentials::Credential::TargetName::get()
{
    CheckNotDisposed();
    return m_targetName;
}
...
//
//*****************************************************************************
WinCredentials::CredentialType WinCredentials::Credential::Type::get()
{
    CheckNotDisposed();
    return m_type;
}
...
//
//*****************************************************************************
String^ WinCredentials::Credential::UserName::get()
{
    CheckNotDisposed();
    return m_userName;
}
void WinCredentials::Credential::UserName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Security::SecureString^ WinCredentials::Credential::Password::get()
{
    CheckNotDisposed();
    return m_password;
}
void WinCredentials::Credential::Password::set(Security::SecureString^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
WinCredentials::CredentialPersistence WinCredentials::Credential::Persistence::get()
{
    CheckNotDisposed();
    return m_persistence;
}
void WinCredentials::Credential::Persistence::set(CredentialPersistence value)
{
    CheckNotDisposed();
    m_persistence = value;
}
...
//
//*****************************************************************************
String^ WinCredentials::Credential::Description::get()
{
    CheckNotDisposed();
    return m_description;
}
void WinCredentials::Credential::Description::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
DateTime WinCredentials::Credential::LastWriteTime::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
DateTime WinCredentials::Credential::LastWriteTimeUtc::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
int WinCredentials::Credential::SecrectLength::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void WinCredentials::Credential::Load()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void WinCredentials::Credential::Save()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void WinCredentials::Credential::Delete()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void WinCredentials::Credential::ChangeTargetName(String^ newTargetName)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::Credential::Exists(String^ targetName,
                              CredentialType type)
{
    if (nullptr == targetName)
    {
...
//
//*****************************************************************************
void WinCredentials::Credential::Delete(String^ targetName,
                              CredentialType type)
{
    if (nullptr == targetName)
    {
...
//
//*****************************************************************************
WinCredentials::Credential::Credential(PCREDENTIAL credential)
{
...
//
//*****************************************************************************
void WinCredentials::Credential::Initialize(PCREDENTIAL credential)
{
...
//
//*****************************************************************************
void WinCredentials::Credential::Initialize(String^ targetName,
                                  CredentialType type,
                                  String^ userName,
                                  Security::SecureString^ password,
                                  int secretLength,
...
//
//*****************************************************************************
void WinCredentials::Credential::CheckNotDisposed()
{
    if (m_disposed)
    {
