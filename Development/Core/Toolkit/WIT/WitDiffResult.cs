...
namespace Microsoft.TeamFoundation.Migration.Toolkit.ServerDiff
{
    ...
    internal class WitDiffPair
    {
        ...
        private List<string> m_missingLinks = new List<string>();   
        ...
        public void AddMissingLink(string missingLink)
        {
            m_missingLinks.Add(missingLink);
        }
