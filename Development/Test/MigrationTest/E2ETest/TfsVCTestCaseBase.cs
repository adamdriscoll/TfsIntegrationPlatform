...
namespace TfsVCTest
{
    public abstract class TfsVCTestCaseBase : VCMigrationTestCaseBase
    {
        ...
        {
            return ((TestEnvironment.TargetEndPoint.AdapterType == AdapterType.TFS2008VC) || (TestEnvironment.TargetEndPoint.AdapterType == AdapterType.TFS2010VC))
                && ((TestEnvironment.SourceEndPoint.AdapterType == AdapterType.TFS2008VC) || (TestEnvironment.SourceEndPoint.AdapterType == AdapterType.TFS2010VC));
        }
    }
}
