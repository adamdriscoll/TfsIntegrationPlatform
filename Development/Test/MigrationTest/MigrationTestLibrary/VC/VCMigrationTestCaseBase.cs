...
namespace MigrationTestLibrary
{
    public abstract class VCMigrationTestCaseBase : MigrationTestBase
    {
        ...
        public override void Initialize()
        {
            ...
            m_sourceAdapter = (IVCTestCaseAdapter)TestAdapterManager.LoadAdapter(sourceTCAdapterEnv.TCAdapterID);
            m_targetAdapter = (IVCTestCaseAdapter)TestAdapterManager.LoadAdapter(targetTCAdapterEnv.TCAdapterID);
