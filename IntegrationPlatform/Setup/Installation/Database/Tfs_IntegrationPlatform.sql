...
GO
CREATE DATABASE [Tfs_IntegrationPlatform] ON ( NAME = N'Tfs_IntegrationPlatform', FILENAME = N'D:\Tfs_IntegrationPlatform.mdf') COLLATE SQL_Latin1_General_CP1_CS_AS 
GO
...
GO
EXECUTE sp_addextendedproperty @name = N'FriendlyName', @value = 'TFS Integration Platform Database v2.13';
...
GO
EXECUTE sp_addextendedproperty @name = N'ReferenceName', @value = '75DC3A21-AF0B-4161-A813-C2BF8E3AAA35';
