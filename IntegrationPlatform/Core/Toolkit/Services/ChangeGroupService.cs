...
namespace Microsoft.TeamFoundation.Migration.Toolkit
{
    ...
    public class ChangeGroupService : IServiceProvider
    {
        ...
        public bool UpdateConversionHistoryAndRemovePendingChangeGroups(string migrationInstructionName, string deltaTableName, string comment)
        {
            return m_changeGroupManager.UpdateConversionHistoryAndRemovePendingChangeGroups(migrationInstructionName, deltaTableName, comment);
        }
