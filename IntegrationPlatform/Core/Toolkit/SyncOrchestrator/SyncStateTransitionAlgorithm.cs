...
namespace Microsoft.TeamFoundation.Migration.Toolkit
{
    ...
    {
        // to\from              Default     Started     Paused      StoppedSingle   Stopped Starting    Pausing     StoppingSingle  Stopping  PausingForConflict PausedByConflict
        ...
        // Starting             START       --          RESUME      START_NEW       --      START       --          --              --             --            START_NEW                 
        //                      START_NEW                                                   START_NEW
        ...
        //  
        // PausingForConflict   PAUSE_CONF  PAUSE_CONF  PAUSE_CONF  --              --      PAUSE_CONF  PAUSE_CONF  PAUSE_CONF      --             --            --
        //
        // PausedByConflict     --          --          --          --              --      --          --          --              --             PAUSE_CONF    --
        ...
        public virtual bool TransitAtPausingForConflict(PipelineSyncCommand command, out PipelineState currentState)
        {
            bool transitSucceeded = false;
            currentState = PipelineState.Default;
            switch (command)
