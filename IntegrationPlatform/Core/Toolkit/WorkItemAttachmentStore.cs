...
namespace Microsoft.TeamFoundation.Migration.Toolkit
{
    ...
    public class FileAttachmentMetadata : IMigrationFileAttachment
    {
        ...
        internal static FileAttachmentMetadata Create(System.Xml.XmlDocument updateDocument)
        {
            try
            {
                ...
                return new FileAttachmentMetadata(
                    ...
                    GetAttachmentDateAttributeValue(attachmentNode, "UtcCreationDate"),
                    GetAttachmentDateAttributeValue(attachmentNode, "UtcLastWriteDate"),
        ...
        private static DateTime GetAttachmentDateAttributeValue(XmlNode attachmentNode, string dateAttributeName)
        {
            DateTime dateTime;

            try
            {
                dateTime = DateTime.Parse(attachmentNode.Attributes[dateAttributeName].Value);
            }
            catch
            {
