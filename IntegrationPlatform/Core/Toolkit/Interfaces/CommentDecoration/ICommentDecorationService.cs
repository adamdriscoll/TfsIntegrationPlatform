...
namespace Microsoft.TeamFoundation.Migration.Toolkit
{
    ...
    /// <summary>
    /// The interface for the comment decoration service
    /// </summary>
    public interface ICommentDecorationService
    {
        ...
        /// </summary>
        /// <param name="id">An Id that identifies corresponding item on the peer server</param>
        /// <param name="utc">The creation date of the changeset that is getting migrated</param>
        /// <returns></returns>
        string GetChangeGroupCommentSuffix(string id, DateTime utc);
