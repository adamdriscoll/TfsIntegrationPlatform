...
namespace Microsoft.TeamFoundation.Migration.Toolkit
{
    ...
    public interface IWITDiffProvider : IDiffProvider, IServiceProvider
    {
        ...
        /// Note however that some adapters may wish to return items in batches, so GetWITDiffItems will be called multiple
        /// times until it returns no items, so an adapter should be prepared to return 0 items on the 2nd call if it returns
        /// all of the items on the first call.
        /// </summary>
