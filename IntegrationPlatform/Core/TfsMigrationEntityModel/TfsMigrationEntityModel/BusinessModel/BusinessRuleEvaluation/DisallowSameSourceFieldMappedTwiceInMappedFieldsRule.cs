...
namespace Microsoft.TeamFoundation.Migration.BusinessModel.BusinessRuleEvaluation
{
    ...
    class DisallowSameSourceFieldMappedTwiceInMappedFieldsRule : IEvaluationRule
    {
        ...
        private bool IsSourceFieldMissing(MappedField mappedField)
        {
            string mapFromFieldName = (mappedField.MapFromSide == SourceSideTypeEnum.Left ? mappedField.LeftName : mappedField.RightName);
            return WitMappingConfigVocab.MissingField.Equals(mapFromFieldName, System.StringComparison.OrdinalIgnoreCase);
        }
    }
}
