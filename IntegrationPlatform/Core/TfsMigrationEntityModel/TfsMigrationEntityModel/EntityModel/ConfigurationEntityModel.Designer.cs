...
namespace Microsoft.TeamFoundation.Migration.EntityModel
{
    ...
    public partial class TfsMigrationConsolidatedDBEntities : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        /// <param name="filter1MigrationSource">No Metadata Documentation available.</param>
        /// <param name="filter1">No Metadata Documentation available.</param>
        /// <param name="filter2MigrationSource">No Metadata Documentation available.</param>
        /// <param name="filter2">No Metadata Documentation available.</param>
        /// <param name="sessionConfigUniqueId">No Metadata Documentation available.</param>
        public ObjectResult<FilterItemPair> AddVCCloakedPath(Nullable<global::System.Guid> filter1MigrationSource, global::System.String filter1, Nullable<global::System.Guid> filter2MigrationSource, global::System.String filter2, Nullable<global::System.Guid> sessionConfigUniqueId)
        {
            ObjectParameter filter1MigrationSourceParameter;
            if (filter1MigrationSource.HasValue)
            {
                filter1MigrationSourceParameter = new ObjectParameter("Filter1MigrationSource", filter1MigrationSource);
            }
            else
            {
                filter1MigrationSourceParameter = new ObjectParameter("Filter1MigrationSource", typeof(global::System.Guid));
            }
    
            ObjectParameter filter1Parameter;
            if (filter1 != null)
            {
                filter1Parameter = new ObjectParameter("Filter1", filter1);
            }
            else
            {
                filter1Parameter = new ObjectParameter("Filter1", typeof(global::System.String));
            }
    
            ObjectParameter filter2MigrationSourceParameter;
            if (filter2MigrationSource.HasValue)
            {
                filter2MigrationSourceParameter = new ObjectParameter("Filter2MigrationSource", filter2MigrationSource);
            }
            else
            {
                filter2MigrationSourceParameter = new ObjectParameter("Filter2MigrationSource", typeof(global::System.Guid));
            }
    
            ObjectParameter filter2Parameter;
            if (filter2 != null)
            {
                filter2Parameter = new ObjectParameter("Filter2", filter2);
            }
            else
            {
                filter2Parameter = new ObjectParameter("Filter2", typeof(global::System.String));
            }
    
            ObjectParameter sessionConfigUniqueIdParameter;
            if (sessionConfigUniqueId.HasValue)
            {
                sessionConfigUniqueIdParameter = new ObjectParameter("SessionConfigUniqueId", sessionConfigUniqueId);
            }
            else
            {
                sessionConfigUniqueIdParameter = new ObjectParameter("SessionConfigUniqueId", typeof(global::System.Guid));
            }
    
            return base.ExecuteFunction<FilterItemPair>("AddVCCloakedPath", filter1MigrationSourceParameter, filter1Parameter, filter2MigrationSourceParameter, filter2Parameter, sessionConfigUniqueIdParameter);
        }
        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        ...
        /// <param name="filter2">No Metadata Documentation available.</param>
        /// <param name="sessionConfigUniqueId">No Metadata Documentation available.</param>
        public ObjectResult<FilterItemPair> AddVCCloakedPath(Nullable<global::System.Guid> filter1MigrationSource, global::System.String filter1, Nullable<global::System.Guid> filter2MigrationSource, global::System.String filter2, Nullable<global::System.Guid> sessionConfigUniqueId, MergeOption mergeOption)
        {
            ObjectParameter filter1MigrationSourceParameter;
            if (filter1MigrationSource.HasValue)
            {
            ...
            return base.ExecuteFunction<FilterItemPair>("AddVCCloakedPath", mergeOption, filter1MigrationSourceParameter, filter1Parameter, filter2MigrationSourceParameter, filter2Parameter, sessionConfigUniqueIdParameter);
        }
