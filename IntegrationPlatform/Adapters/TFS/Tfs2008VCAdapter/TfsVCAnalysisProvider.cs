...
namespace Microsoft.TeamFoundation.Migration.Tfs2008VCAdapter
{
    public class TfsVCAnalysisProvider : IAnalysisProvider
    {
        ...
        internal MappingResult IsPathMapped(string serverPath, int referencedChangeset)
        {
            ...
            {
                int snapshotChangeset = int.Parse(mappingEntry.SnapshotStartPoint);
        ...
        {
            TeamFoundationServer tfsServer = TeamFoundationServerFactory.GetServer(migrationSourceConfig.ServerUrl);
