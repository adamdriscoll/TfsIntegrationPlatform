...
namespace Microsoft.TeamFoundation.Migration.Tfs2010VCAdapter
{
    ...
    public class BatchedItem
    {
        ...
        {
            if (!m_sourceAdjustedForParentRename)
            {
                m_source = newSource;
                m_sourceAdjustedForParentRename = true;
            }
        }
        ...
        public bool AlwaysAcceptMineInvalidated
        {
            get
            {
                return m_alwaysAcceptMineInvalidated;
            }
            set
            {
                m_alwaysAcceptMineInvalidated = value;
            }
        }
        ...
        bool m_resolved;
        bool m_sourceAdjustedForParentRename;
        int m_priority; 
        ...
        bool m_alwaysAcceptMineInvalidated;
