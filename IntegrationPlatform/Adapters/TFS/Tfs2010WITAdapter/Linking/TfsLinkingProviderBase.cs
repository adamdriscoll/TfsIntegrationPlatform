...
namespace Microsoft.TeamFoundation.Migration.Tfs2010WitAdapter.Linking
{
    public abstract class TfsLinkingProviderBase : ILinkProvider
    {
        ...
        protected LinkService m_linkService;                                // LinkService for creating LinkChangeGroup, etc.
        protected ILinkTranslationService m_linkTranslationService;         // LinkTranslationService for creating LinkChangeGroup, etc.
        ...
        protected HighWaterMark<long> m_hwmLinkSequenceNumber;
        ...
        public enum LinkSubmissionPhase
        {
            Edit,
            Deletion,
            Add,
        ...
        public virtual void Initialize(ServiceContainer serviceContainer)
        {
            ...
            m_linkService = serviceContainer.GetService(typeof(LinkService)) as LinkService;
            ...
            m_hwmLinkSequenceNumber = new HighWaterMark<long>(TfsConstants.HwmDeltaLinkChangeId);
            m_configurationService.RegisterHighWaterMarkWithSession(m_hwmLinkSequenceNumber);
        ...
        {
            SubmitLinkChange(linkService, LinkSubmissionPhase.Edit);
            SubmitLinkChange(linkService, LinkSubmissionPhase.Deletion);
            SubmitLinkChange(linkService, LinkSubmissionPhase.Add);
        }
