...
namespace Microsoft.TeamFoundation.Migration.Tfs2008WitAdapter
{
    ...
    public class TfsCore
    {
        ...
        public string UserName
        {
            get
            {
                return m_store.UserDisplayMode == UserDisplayMode.FriendlyName ?
                    m_srv.AuthenticatedUserIdentity.DisplayName : m_srv.AuthenticatedUserIdentity.Domain + "\\" + m_srv.AuthenticatedUserIdentity.AccountName;
            }
        }
        ...
        public TfsCore(TfsMigrationDataSource cfg)
        {
            ...
            m_srv = new TeamFoundationServer(cfg.ServerName);
            ...
            m_name = string.Format(
                ...
                "{0} ({1})",
                m_store.TeamFoundationServer.Name,
                m_cfg.Project);
            ...
            IRegistration regSvc = (IRegistration)m_store.TeamFoundationServer.GetService(typeof(IRegistration));
        ...
        public ITfsWorkItemServer CreateWorkItemServer()
        {
            ...
            svc.Url = m_witUrl;
            svc.AttachmentsUrl = m_attachUrl;
            svc.ConfigurationUrl = m_configUrl;
            svc.CallingProcessIdentity = TeamFoundationSoapProxy.DefaultUserAgent;

            Debug.Assert(null != m_store, "m_store is NULL");
            return new Tfs2008WorkItemServer(m_store.TeamFoundationServer, svc);
        }
        ...
        internal ICommonStructureService Css
        {
            get
            {
                if (m_css == null)
                {
                    m_css = (ICommonStructureService)m_store.TeamFoundationServer.GetService(typeof(ICommonStructureService));
                }
                return m_css;
            }
        }
        ...
        private TeamFoundationServer m_srv;                 // Team foundation server
