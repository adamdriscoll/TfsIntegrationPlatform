...
namespace Microsoft.TeamFoundation.Migration.ClearCaseSelectedHistoryAdapter
{
    ...
    {
        private const string m_adapterGuid = "94A350FF-9B1B-48CF-8AB3-12519B0D2BED";
        private const string m_adapterName = "ClearCase Selected History Adapter for Tfs 11";
