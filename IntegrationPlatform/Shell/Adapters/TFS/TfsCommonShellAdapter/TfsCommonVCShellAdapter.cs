...
namespace Microsoft.TeamFoundation.Migration.Shell.TfsCommonShellAdapter
{
    public abstract class TfsCommonVCShellAdapter : TfsCommonShellAdapter
    {
        ...
        static TfsCommonVCShellAdapter()
        {
            ...
            s_conflictTypes.Add(new ConflictTypeView
            {
                Guid = new TfsCheckinFailureConflictType().ReferenceName,
                FriendlyName = Resources.TfsCheckinFailureConflictTypeFriendlyName,
                Description = Resources.TfsCheckinFailureConflictTypeDescription,
                Type = typeof(TfsCheckinFailureConflictTypeViewModel)
            });
            s_conflictTypes.Add(new ConflictTypeView
            {
