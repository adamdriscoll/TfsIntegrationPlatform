...
{
    public class CCCheckinConflictTypeViewModel : ConflictTypeViewModelBase
    {
        public CCCheckinConflictTypeViewModel()
        {
            ConflictTypeDescription = Properties.Resources.CCCheckinConflictTypeDescription;
            ...
            ResolutionActionViewModel skipAction = new ResolutionActionViewModel()
            {
                ...
                ResolutionActionReferenceName = new CCCheckinConflictSkipAction().ReferenceName,
                IsSelected = true
            };
            ...
            get
            {
                if (m_details == null)
                {
                    ...
                    m_details["Description"] = CreateTextElement(
                        string.Format("{0} {1} ", Properties.Resources.CCCheckinConflictDetails,
