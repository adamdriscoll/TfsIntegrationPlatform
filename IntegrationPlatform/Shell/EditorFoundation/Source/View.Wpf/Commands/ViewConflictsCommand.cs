...
namespace Microsoft.TeamFoundation.Migration.Shell.View
{
    ...
    public class ViewConflictsCommand : ViewModelCommand<ShellController, ConfigurationModel>
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewConflictsCommand&lt;TController, TModel&gt;"/> class.
        /// </summary>
        /// <param name="viewModel">The view model.</param>
        public ViewConflictsCommand (ShellViewModel viewModel)
            : base (viewModel)
        {
        }
        #endregion
        ...
        protected override string ViewModelPropertyName
        {
            get
            {
                return "CanViewConflictsCommand";
            }
        }
        #endregion
        ...
        public static void Open (ShellViewModel viewModel)
        {
            ...
            viewModel.ShowMigrationView = MigrationStatusViews.Conflicts;
        }
        #endregion
    ...
    /// <summary>
    /// Provides a <see cref="CommandBinding"/> that delegates the <see cref="ApplicationCommands.Open"/> routed command to the <see cref="ViewConflictsCommand&lt;TController, TModel&gt;"/>.
    /// </summary>
    /// <typeparam name="TController">The type of the controller.</typeparam>
    /// <typeparam name="TModel">The type of the model.</typeparam>
    public class ViewConflictsCommandBinding : CommandBinding
    {
        #region Constructors
        /// <summary>
