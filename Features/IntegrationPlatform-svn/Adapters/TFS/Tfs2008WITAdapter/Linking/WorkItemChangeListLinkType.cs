...
{
    [Serializable]
    public class WorkItemChangeListLinkType : LinkType, ILinkHandler
    {
        private const string REFERENCE_NAME = "Microsoft.TeamFoundation.Migration.TFS.LinkType.WorkItemToChangeset";
        private const string FRIENDLY_NAME = "Team Foundation Server WorkItem-to-Changeset link type";
        private static readonly ArtifactType s_sourceArtifactType = new WorkItemArtifactType();
        private static readonly ArtifactType s_targetArtifactType = new ChangeListArtifactType();
        ...
        public WorkItemChangeListLinkType()
        ...
        public bool UpdateTfs(TfsUpdateDocument updateDoc, LinkChangeAction linkChangeAction)
        {
            ...
            {
                updateDoc.AddExternalLink(LinkingConstants.VcChangelistLinkType, uri, comment);
            }
        ...
        public static bool IsMyLink(ExternalLink externalLink)
        {
            return TFStringComparer.ArtifactType.Equals(externalLink.ArtifactLinkType.Name, LinkingConstants.VcChangelistLinkType)
                && TfsChangeListHandler.IsMyUri(externalLink.LinkedArtifactUri);
        }
