...
namespace Microsoft.TeamFoundation.Migration.Tfs2008WitAdapter
{
    ...
    public partial class TfsMigrationWorkItemStore : IComparer<Identity>
    {
        ...
        {
            return workItemStore.TeamFoundationServer.GetService(typeof(IGroupSecurityService)) as IGroupSecurityService;
        }
            ...
            ServiceContainer serviceContainer)
        {
            if (ByPassrules)
            {
                SubmitLinkChangesWithUpdateDoc(linkChanges, serviceContainer);
            }
            else
            {
                SubmitLinkChangesWithUpdateDoc(linkChanges, serviceContainer);
            ...
            List<LinkChangeAction> syncedLinkActions)
        {
            ...
            relatedArtifactsStore.UpdateSyncedLinks(syncedLinkActions);
        }
