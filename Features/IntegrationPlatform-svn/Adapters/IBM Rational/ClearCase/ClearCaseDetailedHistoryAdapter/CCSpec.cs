...
namespace Microsoft.TeamFoundation.Migration.ClearCaseDetailedHistoryAdapter
{
    ...
    {
        const string AddDirectoryElementPrefix = "Added directory element \"";
        const int AddDirectoryElementPrefixLength = 25;
        const string AddFileElementPrefix = "Added file element \"";
        const int AddFileElementPrefixLength = 20;
        const char SubItemEndCharacter = '"';

        const string UncatalogedDirectoryElementPrefix = "Uncataloged directory element \"";
        const int UncatalogedDirectoryElementPrefixLength = 31;
        const string UncatalogedFileElementPrefix = "Uncataloged file element \"";
        const int UncatalogedFileElementPrefixLength = 26;
        ...
        {
            if (eventComment.StartsWith(AddDirectoryElementPrefix))
            {
                return eventComment.Substring(AddDirectoryElementPrefixLength, eventComment.IndexOf(SubItemEndCharacter, AddDirectoryElementPrefixLength) - AddDirectoryElementPrefixLength);
            }
            else if (eventComment.StartsWith(AddFileElementPrefix))
            {
                return eventComment.Substring(AddFileElementPrefixLength, eventComment.IndexOf(SubItemEndCharacter, AddFileElementPrefixLength) - AddFileElementPrefixLength);
            }
            return null;
        }
        ...
        {
            isDirectory = false;
            if (eventComment.StartsWith(UncatalogedDirectoryElementPrefix))
            {
                isDirectory = true;
                return eventComment.Substring(UncatalogedDirectoryElementPrefixLength, eventComment.IndexOf(SubItemEndCharacter, UncatalogedDirectoryElementPrefixLength) - UncatalogedDirectoryElementPrefixLength);
            }
            else if (eventComment.StartsWith(UncatalogedFileElementPrefix))
            {
                return eventComment.Substring(UncatalogedFileElementPrefixLength, eventComment.IndexOf(SubItemEndCharacter, UncatalogedFileElementPrefixLength) - UncatalogedFileElementPrefixLength);
            }
            return null;
        }
