...
//
//*****************************************************************************
WinCredentials::PromptForCredential::PromptForCredential() :
...
//
//*****************************************************************************
String^ WinCredentials::PromptForCredential::TargetName::get()
{
    CheckNotDisposed();
    return m_targetName;
}
void WinCredentials::PromptForCredential::TargetName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
int WinCredentials::PromptForCredential::ErrorCode::get()
{
    CheckNotDisposed();
    return m_errorCode;
}
void WinCredentials::PromptForCredential::ErrorCode::set(int value)
{
    CheckNotDisposed();
    m_errorCode = value;
}
...
//
//*****************************************************************************
String^ WinCredentials::PromptForCredential::UserName::get()
{
    CheckNotDisposed();
    return m_userName;
}
void WinCredentials::PromptForCredential::UserName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Security::SecureString^ WinCredentials::PromptForCredential::Password::get()
{
    CheckNotDisposed();
...
void WinCredentials::PromptForCredential::Password::set(Security::SecureString^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::SaveChecked::get()
{
    CheckNotDisposed();
    return m_saveChecked;
}
void WinCredentials::PromptForCredential::SaveChecked::set(bool value)
{
    CheckNotDisposed();
    m_saveChecked = value;
}
...
//
//*****************************************************************************
String^ WinCredentials::PromptForCredential::Message::get()
{
    CheckNotDisposed();
    return m_message ? m_message : String::Empty;
}
void WinCredentials::PromptForCredential::Message::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
String^ WinCredentials::PromptForCredential::Title::get()
{
    CheckNotDisposed();
    return m_title ? m_title : String::Empty;
}
void WinCredentials::PromptForCredential::Title::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Drawing::Bitmap^ WinCredentials::PromptForCredential::Banner::get()
{
    CheckNotDisposed();
    return m_banner;
}
void WinCredentials::PromptForCredential::Banner::set(Drawing::Bitmap^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::AlwaysShowUI::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::CompleteUserName::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_COMPLETE_USERNAME & m_flags);
}
void WinCredentials::PromptForCredential::CompleteUserName::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::DoNotPersist::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::ExcludeCertificates::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_EXCLUDE_CERTIFICATES & m_flags);
}
void WinCredentials::PromptForCredential::ExcludeCertificates::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::ExpectConfirmation::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_EXPECT_CONFIRMATION & m_flags);
}
void WinCredentials::PromptForCredential::ExpectConfirmation::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::GenericCredentials::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_GENERIC_CREDENTIALS & m_flags);
}
void WinCredentials::PromptForCredential::GenericCredentials::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::IncorrectPassword::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_INCORRECT_PASSWORD & m_flags);
}
void WinCredentials::PromptForCredential::IncorrectPassword::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::Persist::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::RequestAdministrator::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUEST_ADMINISTRATOR & m_flags);
}
void WinCredentials::PromptForCredential::RequestAdministrator::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::RequireCertificate::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUIRE_CERTIFICATE & m_flags);
}
void WinCredentials::PromptForCredential::RequireCertificate::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::RequireSmartCard::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUIRE_SMARTCARD & m_flags);
}
void WinCredentials::PromptForCredential::RequireSmartCard::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::ShowSaveCheckBox::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_SHOW_SAVE_CHECK_BOX & m_flags);
}
void WinCredentials::PromptForCredential::ShowSaveCheckBox::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::UserNameReadOnly::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_KEEP_USERNAME & m_flags);
}
void WinCredentials::PromptForCredential::UserNameReadOnly::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool WinCredentials::PromptForCredential::ValidateUserName::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_VALIDATE_USERNAME & m_flags);
}
void WinCredentials::PromptForCredential::ValidateUserName::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Windows::Forms::DialogResult WinCredentials::PromptForCredential::ShowDialog()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Windows::Forms::DialogResult WinCredentials::PromptForCredential::ShowDialog(Windows::Forms::IWin32Window^ owner)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void WinCredentials::PromptForCredential::ConfirmCredentials()
{
    CheckNotDisposed();
    pin_ptr<const wchar_t> pinnedTargetName = PtrToStringChars(m_targetName);
...
//
//*****************************************************************************
void WinCredentials::PromptForCredential::Flag(bool add,
                                     DWORD flag)
{
    if (add)
    {
...
//
//*****************************************************************************
void WinCredentials::PromptForCredential::CheckNotDisposed()
{
    if (m_disposed)
    {
