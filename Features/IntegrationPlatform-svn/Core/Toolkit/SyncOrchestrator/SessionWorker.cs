    ...
    class SessionWorker : ISessionOrchestrator
    {
            ...
            bool bidirection)
        {
            try
            {
                ...
                TraceManager.TraceInformation("Generating linking delta for the migration source {0}", targetMigrationSourceId);
                LinkEngine.GenerateLinkDelta(SessionId, targetMigrationSourceId);
                m_orchPolicy.Check();
        ...
        public void Pause()
        {
            ...
            {
                TraceManager.TraceError("Pause failed");
            }
        }
        ...
        public void Resume()
        {
            ...
            {
                TraceManager.TraceError("Resume failed");
            }
        }
        ...
        public void Stop()
        {
            if (!m_syncStateMachine.TryTransit(PipelineSyncCommand.STOP))
            {
                TraceManager.TraceError("Stop failed");
            }
        }
