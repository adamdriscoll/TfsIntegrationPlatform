...
EXECUTE sp_addextendedproperty @name = N'FriendlyName', @value = 'TFS Synchronization and Migration Database v2.2';
...
EXECUTE sp_addextendedproperty @name = N'ReferenceName', @value = 'CC9A877B-74D6-4A90-990B-97856D2BF5AF';
GO
