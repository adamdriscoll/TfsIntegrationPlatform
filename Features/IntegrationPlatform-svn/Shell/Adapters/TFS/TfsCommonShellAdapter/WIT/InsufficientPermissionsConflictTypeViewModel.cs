        ...
        public override Dictionary<string, FrameworkElement> Details
        {
            get
            {
                if (m_details == null)
                {
                    ...
                    string details = string.Format(@"User '{0}\{1}' needs to be in TFS permission group '{2}'.",
                        properties[InsufficientPermissionConflictTypeConstants.ConflictDetailsKey_UserDomain],
