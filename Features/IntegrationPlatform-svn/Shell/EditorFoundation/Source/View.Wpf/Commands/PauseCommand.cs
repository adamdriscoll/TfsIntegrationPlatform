...
namespace Microsoft.TeamFoundation.Migration.Shell.View
{
    ...
    /// </summary>
    public class PauseCommand : ViewModelCommand<ShellController, ConfigurationModel>
    {
        #region Constructors
        /// <summary>
        ...
        public PauseCommand(ShellViewModel viewModel)
            : base(viewModel)
        {
        }
        #endregion
        ...
        /// </returns>
        public static bool CanPause (ShellViewModel viewModel)
        {
        ...
        public static void Pause (ShellViewModel viewModel)
        {
            viewModel.Pause();
        }
        #endregion
        ...
        {
            return PauseCommand.CanPause (viewModel);
        }

        internal static void Execute (ShellViewModel viewModel)
        {
            PauseCommand.Pause (viewModel);
        }
        #endregion
    }
    ...
    public class PauseCommandBinding : CommandBinding
    {
        #region Constructors
        /// <summary>
        ...
        /// </summary>
        /// <param name="viewModel">The view model.</param>
        public PauseCommandBinding (ShellViewModel viewModel)
        {
            this.Command = MediaCommands.Pause;

            PauseCommand command = new PauseCommand(viewModel);
