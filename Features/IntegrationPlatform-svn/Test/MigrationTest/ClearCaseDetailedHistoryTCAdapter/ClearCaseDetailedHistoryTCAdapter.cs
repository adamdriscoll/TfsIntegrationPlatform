...
namespace ClearCaseDetailedHistoryTCAdapter
{
    [TCAdapterDescription(m_adapterGuid, m_adapterName)]
    public class ClearCaseDetailedHistoryTCAdapter : IVCTestCaseAdapter
    {
        #region constants
        ...
        private const string m_adapterName = "ClearCase Detailed History TestCase Adapter";
        ...
        public int BranchItem(string source, string target)
        {
