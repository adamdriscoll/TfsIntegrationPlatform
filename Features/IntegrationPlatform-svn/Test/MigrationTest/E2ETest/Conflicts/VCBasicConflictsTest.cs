...
namespace TfsVCTest.VCBasicConflicts
{
    ...
    public class ContentConflictTest : TfsVCTestCaseBase
    {
        ...
        #region Add,Add conflict - Bi-direcional sync
        ///<summary>
        ///Scenario: 
        ...
        ///</summary>
        [TestMethod(), Priority(1), Owner("hykwon")]
        [Description("TwoWay_AddAddConflictTakeOtherTest")]
        ...
        #region Edit,Edit conflict - Bi-direcional sync
        ///<summary>
        ///Scenario: 
        ///  Repro for Pioneer Dev10 Bug 466785
        ///  1. migrate a.txt -> a.txt
        ...
        ///</summary>
        [TestMethod(), Priority(1), Owner("hykwon")]
        [Description("TwoWay_EditEditConflictTakeLocalTest")]
